...
/// <summary>
/// Entry point for <c>xharness android test --instrumentation pixman.tests.TestInstrumentation</c>.
/// XHarness reads the run's outcome from the <c>return-code</c> key of the result bundle.
/// </summary>
[Instrumentation(Name = "pixman.tests.TestInstrumentation")]
public sealed class TestInstrumentation : Instrumentation
{
    private const string Tag = "pixman-tests";
